...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=trisberg&repo=tanzu-java-web-app",
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=trisberg&repo=tanzu-java-web-app'
